...
PlayState2 PlayState2::m_PlayState;

using namespace std;

void PlayState2::init()
{
    ...
    enemy1.setPosition(280,285);
    enemy2.setPosition(480,285);
    enemy3.setPosition(680,285);
    enemy4.setPosition(880,285);
    enemy5.setPosition(1080,285);
    enemy6.setPosition(1280,285);
    enemy7.setPosition(1480,285);
    enemy8.setPosition(1680,285);

    enemy9.setPosition(1080,637);
    enemy10.setPosition(1280,637);

    map = new tmx::MapLoader("data/maps");
    map->Load("dungeon-tilesets3.tmx");
    ...
    music.openFromFile("audio/durarara2.wav");
    music.setVolume(80);
    music.setLoop(true);
    music.play();
...
void PlayState2::cleanup()
{
	cout << "PlayState Clean Successful" << endl;
	delete map;
}

void PlayState2::pause()
{
	cout << "PlayState Paused" << endl;
}

void PlayState2::resume()
{
	cout << "PlayState Resumed" << endl;
}

void PlayState2::handleEvents(cgf::Game* game)
{
    sf::Event event;
...
void PlayState2::update(cgf::Game* game)
{
...
bool PlayState2::checkCollision(u_int8_t layer, cgf::Game* game, cgf::Sprite* obj)
{
    int i, x1, x2, y1, y2;
    bool bump = false;
...
sf::Uint16 PlayState2::getCellFromMap(uint8_t layernum, float x, float y)
{
...
void PlayState2::centerMapOnPlayer()
{
    sf::View view = screen->getView();
    sf::Vector2u mapsize = map->GetMapSize();
...
void PlayState2::draw(cgf::Game* game)
{
    //sf::View view = screen->getView();
